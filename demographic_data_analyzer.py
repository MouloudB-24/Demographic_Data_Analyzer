...
def calculate_demographic_data(print_data=True):
    ...
    rich_percentage = 100 * num_min_workers / df[df['hours-per-week'] == 1].shape[0]
    ...
    highest_earning_country = pourcentage_by_country.idxmax()
    highest_earning_country_percentage = round(pourcentage_by_country.max(), 1)
